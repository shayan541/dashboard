...
const Header = () => {
  ...
  const { name, setNotifIsChecked, notifIsChecked } = context;
  ...
  return (
    <header dir="ltr" className="bg-gold-100 px-4 h-12 flex items-center justify-between dark:bg-slate-800">
      ...
      <div className="flex gap-4">
        ...
        <OptionBox text={name || notifIsChecked ? t("not_notif") : t("notif")}>
          <div tabIndex={0} onBlur={() => setNotifIsChecked(true)}>
            <svg _ngcontent-ng-c3064967657="" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="#121619"
              ></path>
              {!name && !notifIsChecked && <rect _ngcontent-ng-c3064967657="" width="6" height="6" rx="3" fill="#DA1E28"></rect>}
            </svg>
          </div>
        </OptionBox>
      </div>
